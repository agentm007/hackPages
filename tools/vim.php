...
<html lang="en">
  ...
  <body style="">
    ...
    <h2>Helpful Regex</h2>
    <p>delete lines ending with .<br />
    <code>:g/\.$/d</code></p>

    <p>delete lines starting with x<br />
    <code>:g/^x/d</code></p>

    <p>delete lines not containing<br />
    <code>:g!//d</code></p>

    <p>copy every line with pattern to register A<br />
    <code>:g/pattern/y A</code><br />
    qaq clears the register</p>
